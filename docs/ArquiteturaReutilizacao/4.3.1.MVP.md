...
<p align="justify">
    <i>A primeira interação é o Cadastro:</i> o usuário inicia o processo clicando no botão <strong>Cadastrar</strong> na tela inicial, onde deve fornecer informações básicas como nome de usuário, e-mail e senha. Após preencher os dados, ele deve confirmar o cadastro clicando no botão correspondente, para que as informações sejam registradas no banco de dados.
    &emsp;&emsp;
</p>
