...
![Diagrama Entidade Relacionamento - (DER)](/docs/ArquiteturaReutilizacao/img/dig-conceitual.png)
...
![Diagrama Lógico de Dados - (DLD)](/docs/ArquiteturaReutilizacao/img/dig-logico.png)
