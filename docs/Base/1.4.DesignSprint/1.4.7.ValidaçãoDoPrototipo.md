...
| ENT3 | No aplicativo deve ser possível que o usuário realize a edição do perfil | 
...
| ------ | --------- | ------------------------------------------- | --------- | ---------- |
| `1.0`  | 08/04/2024| adição de conteúdo em metodologia, conclusão e no Roteiro | Maria eduarda Barbosa     | --   |
| `2.0`  | 08/04/2024| adição de conteúdo em introdução, objetivo e conclusão | Maria eduarda Marques    | --   |
| `3.0`  | 08/04/2024| adição de conteúdo na elicitação de requisitos e atualização em conteúdo | Maria eduarda Barbosa     | --   |
