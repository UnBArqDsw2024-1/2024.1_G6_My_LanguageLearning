...
## **Conclusão**
<p align="justify">
&emsp;&emsp; As informações detalhadas fornecidas foram fundamentais para a elaboração do protótipo e para o levantamento de novos requisitos para o nosso sistema. Abaixo na <b> tabela 3</b> pode ser possível visualizar as respostas obtidas com o entrevistado e nos links a seguir se encontram o protótipo utilizado e a entrevista realizada.

- [Protótipo](https://www.figma.com/proto/DKVd7l0ODRA7lo3IimjKrS/prototipo?page-id=0%3A1&type=design&node-id=4-8&viewport=194%2C299%2C0.19&t=PlauxH07yXhoqREF-1&scaling=min-zoom&starting-point-node-id=4%3A8&mode=design)
- [Entrevista](https://youtu.be/6944_-EwTDg)

<h6 align="center">Tabela 3: Respostas da entrevista.</h6>
<div align="center">
  
| Identificador da pergunta | Página do ptotótipo que a pergunta se refere | Resposta | 
| ----------- | --- |-------- |
| P1 | -| 21 anos | 
...
| `2.0`  | 08/04/2024| adição de conteúdo em introdução, objetivo e conclusão | Maria eduarda Marques    | --   |
